...
include "../sidebar.php";
$id = $_GET['id'];
$sql = "SELECT* FROM products_type WHERE id = '$id'";
...
<form action="<?php echo base_url?>/products-type/add-products-submit.php" class="products_type main-footer" method="POST"  enctype="multipart/form-data">
  ...
  <!-- Heading 1 Start  (H5)-->
  <input class="form-control mb-3" type="text" placeholder="products_type " name="products_type" value = "<?php echo $row['products_type'];?>">
